...
# -----------------------------------------------------------------------
# Active parameters — lower model N=5 optimum (see optimization-results.txt)
# -----------------------------------------------------------------------
Delta0_zs     = 4.2   # representative of 4.0–4.3 Γ range; see optimization-results.txt
Delta0_2DMOT  = 2.27  # lower-model N=5 2DMOT-only optimum
...
if __name__ == "__main__":
    # velocity sweep — 2DMOT-only regime (40–50 m/s) through ZS-assisted regime (~131 m/s)
    ...
    v0z_sweep = np.linspace(40, 145, 22)
    Ni        = 200
